...
export default function Home() {
  ...
  const industriesInfo = {
    Aerospace: {
      blurb: 'Lightweight brackets, ducts, and tooling with documentation and process traceability for regulated programs. High-performance parts that meet stringent aerospace standards.'
    },
    Defence: {
      blurb: 'Ruggedized parts and on-demand spares using engineering polymers and metals for mission-readiness. Custom solutions for defense applications with security and reliability.'
    },
    Medical: {
      blurb: 'Patient-specific models, dental fixtures, surgical guides, and biocompatible components with validated workflows. FDA-compliant materials and processes for medical applications.'
    },
    Tooling: {
      blurb: 'Custom jigs, fixtures, and production tools with rapid turnaround. Optimize your manufacturing process with additive tooling solutions that reduce costs and lead times.'
    },
    Automotive: {
      blurb: 'Jigs, fixtures, and prototype housings enabling faster iteration and ergonomic improvements. From concept cars to production parts with advanced materials.'
    },
    'Oil & Gas': {
      blurb: 'Flow components and heat-resistant parts with complex internal channels for demanding environments. Corrosion-resistant materials for harsh operating conditions.'
    }
  }
  return (
    <div className="min-h-screen text-white relative overflow-hidden bg-gradient-to-br from-black via-[#0f0b0b] to-[#b91c1c]">
      ...
      <section className="relative min-h-[100svh] md:min-h-screen flex items-center pt-24">
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-10 items-center relative z-20">
            <div>
              <div className="text-xs font-['dena'] tracking-widest text-red-300 mb-3 uppercase">Contract Manufacturing</div>
              <h1 className="text-5xl md:text-7xl font-['test'] leading-tight mb-6">Engineering your Concept to Creation</h1>
              <p className="text-red-50/90 font-['scrib'] text-lg md:text-xl mb-6">with Additive Manufacturing</p>
      ...
      <section className="py-20 relative">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-5xl font-['test'] mb-6">Your One-Stop Destination for Advanced Manufacturing</h2>
              <p className="text-gray-300 font-['scrib'] text-lg mb-6">
                Galactic 3D is your one-stop destination for advanced manufacturing services. As pioneers in the field, we bridge the gap to the future with cutting-edge technology and expert support. We offer customized, efficient, and high-precision solutions across industries, delivering unmatched quality and innovation with every project.
              </p>
              <div className="space-y-4 mb-8">
                <h3 className="text-xl font-['dena'] text-red-300 mb-4">Our services span across four key verticals:</h3>
            ...
            <div>
              <div className="grid grid-cols-1 gap-6">
                <div className="bg-gradient-to-br from-red-500/20 to-red-500/5 border border-red-500/30 rounded-xl p-6 backdrop-blur">
                  <div className="text-4xl mb-4"><i className="fa-solid fa-crosshairs text-primary" /></div>
                  <h3 className="text-2xl font-['dena'] mb-2">Precision</h3>
                  <p className="text-gray-300 font-['scrib']">Delivering high-accuracy parts with stringent quality control at every step.</p>
                </div>
                <div className="bg-gradient-to-br from-blue-500/20 to-blue-500/5 border border-blue-500/30 rounded-xl p-6 backdrop-blur">
                  <div className="text-4xl mb-4"><i className="fa-solid fa-lightbulb text-blue-400" /></div>
                  <h3 className="text-2xl font-['dena'] mb-2">Innovation</h3>
                  <p className="text-gray-300 font-['scrib']">Leveraging cutting-edge additive manufacturing technology and expertise.</p>
                </div>
                <div className="bg-gradient-to-br from-green-500/20 to-green-500/5 border border-green-500/30 rounded-xl p-6 backdrop-blur">
                  <div className="text-4xl mb-4"><i className="fa-solid fa-leaf text-green-400" /></div>
                  <h3 className="text-2xl font-['dena'] mb-2">Sustainability</h3>
                  <p className="text-gray-300 font-['scrib']">Reducing waste and energy consumption through additive processes.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card bg-red-500/10 border border-red-500/20 backdrop-blur-xl">
              <div className="text-3xl mb-4"><i className="fa-solid fa-compass-drafting" /></div>
              <h3 className="text-2xl font-['dena'] mb-2">Design & DFAM</h3>
              <p className="text-gray-400 font-['scrib'] mb-4">Expert design for additive manufacturing and data preparation services.</p>
              <ul className="text-gray-400 font-['scrib'] text-sm space-y-1 mb-4 list-none">
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Topology optimization</span></li>
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Lattice structures design</span></li>
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>STL/CAD file preparation</span></li>
              </ul>
            ...
            <div className="card bg-red-500/10 border border-red-500/20 backdrop-blur-xl">
              ...
              <h3 className="text-2xl font-['dena'] mb-2">Contract Manufacturing</h3>
              ...
              <ul className="text-gray-400 font-['scrib'] text-sm space-y-1 mb-4 list-none">
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Rapid prototyping to production</span></li>
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Metal & polymer printing</span></li>
            ...
            <div className="card bg-red-500/10 border border-red-500/20 backdrop-blur-xl">
              ...
              <h3 className="text-2xl font-['dena'] mb-2">Training & Development</h3>
              <p className="text-gray-400 font-['scrib'] mb-4">Skill development and entrepreneurship programs for additive manufacturing.</p>
              <ul className="text-gray-400 font-['scrib'] text-sm space-y-1 mb-4 list-none">
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Design for AM training</span></li>
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Machine operations</span></li>
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Entrepreneurship programs</span></li>
              </ul>
            ...
            <div className="card bg-red-500/10 border border-red-500/20 backdrop-blur-xl">
              ...
              <p className="text-gray-400 font-['scrib'] mb-4">Procure and deploy reliable 3D printing machines with full support.</p>
              <ul className="text-gray-400 font-['scrib'] text-sm space-y-1 mb-4 list-none">
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Machine consultation</span></li>
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Installation & calibration</span></li>
                <li className="flex items-start gap-2"><i className="fa-solid fa-check text-green-500 mt-1" /><span>Maintenance support</span></li>
              </ul>
      ...
      <section className="py-20 bg-gradient-to-b from-transparent to-red-950/20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-5xl font-['test'] mb-4">Transform Your Ideas into Reality</h2>
            <p className="text-gray-300 font-['scrib'] text-lg max-w-3xl mx-auto">
              Leveraging our cutting-edge additive manufacturing facilities, we deliver customized, high-quality parts with unmatched speed and precision.
            </p>
            <div className="flex flex-wrap justify-center gap-4 mt-6">
              <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-2">
                ...
                <span className="text-sm font-['dena']">Sustainability in Manufacturing</span>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-2">
                <i className="fa-solid fa-shield-halved text-blue-400 mr-2" />
                <span className="text-sm font-['dena']">Stringent Quality Control</span>
              </div>
              <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-2">
              ...
              <div className="bg-white/10 border border-white/20 rounded-lg px-4 py-2">
                ...
                <span className="text-sm font-['dena']">Advanced Facilities</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/30 rounded-xl p-8 backdrop-blur">
              <div className="text-5xl mb-4 text-center"><i className="fa-solid fa-bolt text-blue-400" /></div>
              <h3 className="text-2xl font-['dena'] mb-3 text-center">Rapid Prototyping</h3>
            ...
            <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/30 rounded-xl p-8 backdrop-blur">
              <div className="text-5xl mb-4 text-center"><i className="fa-solid fa-industry text-primary" /></div>
              <h3 className="text-2xl font-['dena'] mb-3 text-center">Full-Scale Production</h3>
              <p className="text-gray-300 font-['scrib'] mb-4 text-center">
            ...
            <div className="bg-gradient-to-br from-purple-500/10 to-purple-500/5 border border-purple-500/30 rounded-xl p-8 backdrop-blur">
              <div className="text-5xl mb-4 text-center"><i className="fa-solid fa-wrench text-purple-400" /></div>
              <h3 className="text-2xl font-['dena'] mb-3 text-center">Custom Manufacturing</h3>
              <p className="text-gray-300 font-['scrib'] mb-4 text-center">
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-5xl font-['test'] mb-4 text-center">Our Technologies</h2>
          <p className="text-gray-400 font-['scrib'] mb-12 text-center max-w-2xl mx-auto">
            State-of-the-art additive manufacturing technologies to bring your ideas to life
          </p>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            <div className="bg-gradient-to-br from-red-500/10 to-red-500/5 border border-red-500/30 rounded-xl p-6 text-center backdrop-blur hover:scale-105 transition-transform">
              <div className="text-4xl mb-3"><i className="fa-solid fa-atom text-primary" /></div>
              <h3 className="text-lg font-['dena'] mb-2">DMLS</h3>
              <p className="text-gray-400 font-['scrib'] text-xs">Direct Metal Laser Sintering</p>
            </div>
            <div className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/30 rounded-xl p-6 text-center backdrop-blur hover:scale-105 transition-transform">
              <div className="text-4xl mb-3"><i className="fa-solid fa-cube text-blue-400" /></div>
              <h3 className="text-lg font-['dena'] mb-2">SLS</h3>
              <p className="text-gray-400 font-['scrib'] text-xs">Selective Laser Sintering</p>
            </div>
            <div className="bg-gradient-to-br from-green-500/10 to-green-500/5 border border-green-500/30 rounded-xl p-6 text-center backdrop-blur hover:scale-105 transition-transform">
              <div className="text-4xl mb-3"><i className="fa-solid fa-layer-group text-green-400" /></div>
              <h3 className="text-lg font-['dena'] mb-2">FDM</h3>
              <p className="text-gray-400 font-['scrib'] text-xs">Fused Deposition Modeling</p>
            </div>
            <div className="bg-gradient-to-br from-purple-500/10 to-purple-500/5 border border-purple-500/30 rounded-xl p-6 text-center backdrop-blur hover:scale-105 transition-transform">
              <div className="text-4xl mb-3"><i className="fa-solid fa-droplet text-purple-400" /></div>
              <h3 className="text-lg font-['dena'] mb-2">DLP</h3>
              <p className="text-gray-400 font-['scrib'] text-xs">Digital Light Processing</p>
            </div>
            <div className="bg-gradient-to-br from-yellow-500/10 to-yellow-500/5 border border-yellow-500/30 rounded-xl p-6 text-center backdrop-blur hover:scale-105 transition-transform">
              <div className="text-4xl mb-3"><i className="fa-solid fa-flask text-yellow-400" /></div>
              <h3 className="text-lg font-['dena'] mb-2">Vacuum Casting</h3>
              <p className="text-gray-400 font-['scrib'] text-xs">Precision Casting</p>
            </div>
            <div className="bg-gradient-to-br from-cyan-500/10 to-cyan-500/5 border border-cyan-500/30 rounded-xl p-6 text-center backdrop-blur hover:scale-105 transition-transform">
              <div className="text-4xl mb-3"><i className="fa-solid fa-gears text-cyan-400" /></div>
              <h3 className="text-lg font-['dena'] mb-2">CNC Machining</h3>
              <p className="text-gray-400 font-['scrib'] text-xs">& Fabrication</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-b from-red-950/20 to-transparent">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-5xl font-['test'] mb-4 text-center">We Bring Your Ideas to Life</h2>
          <p className="text-gray-400 font-['scrib'] mb-12 text-center max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            <div className="relative">
              <div className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/30 rounded-xl p-6 text-center backdrop-blur">
                ...
                <p className="text-gray-400 font-['scrib'] text-sm">Optimize your design for additive manufacturing</p>
              </div>
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-purple-500/10 to-purple-500/5 border border-purple-500/30 rounded-xl p-6 text-center backdrop-blur">
                ...
                <p className="text-gray-400 font-['scrib'] text-sm">Rapid prototyping and testing phase</p>
              </div>
              <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-yellow-500/10 to-yellow-500/5 border border-yellow-500/30 rounded-xl p-6 text-center backdrop-blur">
                ...
                <h3 className="text-xl font-['dena'] mb-2">Quality Assurance</h3>
                <p className="text-gray-400 font-['scrib'] text-sm">Rigorous testing and validation</p>
              </div>
              <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/30 rounded-xl p-6 text-center backdrop-blur">
                ...
                <p className="text-gray-400 font-['scrib'] text-sm">Full-scale manufacturing</p>
              </div>
              <div className="hidden md:block absolute top-1/2 -right-3 transform -translate-y-1/2 z-10">
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-green-500/5 border border-green-500/30 rounded-xl p-6 text-center backdrop-blur">
              ...
              <p className="text-gray-400 font-['scrib'] text-sm">Fast and reliable shipping</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <h2 className="text-3xl md:text-5xl font-['test'] mb-4 text-center">Facilities Designed for the Future</h2>
          <p className="text-gray-400 font-['scrib'] mb-12 text-center max-w-3xl mx-auto">
            Our advanced manufacturing facilities are equipped with cutting-edge technology and expert staff, ensuring superior quality and efficiency at every step of the process.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-gradient-to-br from-gray-500/10 to-gray-500/5 border border-gray-500/30 rounded-xl p-8 backdrop-blur">
              <div className="flex items-center gap-3 mb-6">
                <div className="text-4xl"><i className="fa-solid fa-atom text-gray-400" /></div>
                <div>
                  <h3 className="text-2xl font-['dena']">Metal</h3>
                  <p className="text-sm text-gray-400 font-['scrib']">Build Size: Up to 250×250×300mm</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-blue-300">Titanium</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">Ti64AL4V, Ti64 Eli, Gr 5 & 23</p>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-blue-300">Aluminum</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">AlSi10Mg, AlF357, Al6061</p>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-blue-300">Stainless Steel</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">SS 316L, 17-4ph</p>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-blue-300">Tool Steel</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">MS1, HX, Hayens 282</p>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-blue-300">Cobalt Chrome & Nickel Alloy</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">MP1, IN718, 625, 939</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-500/10 to-blue-500/5 border border-blue-500/30 rounded-xl p-8 backdrop-blur">
              <div className="flex items-center gap-3 mb-6">
                <div className="text-4xl"><i className="fa-solid fa-cube text-blue-400" /></div>
                <div>
                  <h3 className="text-2xl font-['dena']">Polymer</h3>
                  <p className="text-sm text-gray-400 font-['scrib']">Build Size: Up to 250×250×250mm</p>
                </div>
              </div>
              <div className="space-y-3">
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-purple-300">Polyamide-12</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">PA 2200, 2202, 2210 FR, 3200 GF</p>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-purple-300">Polyamide-11</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">PA 1100, 1101, 1102</p>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-purple-300">FDM Materials</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">PLA, ABS, TPU, PEEK, TPE, PETG, PP</p>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-purple-300">Resins</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">NYLON, AQUA, Transparent</p>
                </div>
                <div className="bg-white/5 rounded-lg p-3">
                  <h4 className="font-['dena'] text-sm mb-2 text-purple-300">Vacuum Casting</h4>
                  <p className="text-xs text-gray-400 font-['scrib']">PU-ABS, PC, PP, Rubber</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-primary/10 to-blue-500/10 border border-primary/30 rounded-xl p-6 text-center">
            <p className="text-gray-300 font-['scrib'] mb-2">
              ...
              Standards we comply to: <span className="font-['dena'] text-white">ISO Certification Under Progress</span>
            </p>
          </div>
        </div>
      </section>
